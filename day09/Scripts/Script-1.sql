...
GROUP BY M.FIRST_NAME, M.LAST_NAME; -- 매니저 이름과 성으로 그룹화

SELECT M.FIRST_NAME, M.LAST_NAME, COUNT(E.EMPLOYEE_ID)
FROM EMPLOYEES E, EMPLOYEES M		-- EMPLOYEES 테이블을 E와 M으로 별칭지정	
WHERE E.MANAGER_ID = M.EMPLOYEE_ID	-- 일치하는 조건(매니저-직원 관계 매칭)
