...
SELECT * FROM TBL_EMP_NAME;

SELECT *
FROM EMPLOYEES e 
JOIN EMPLOYEES M ON E.MANAGER_ID  =M.EMPLOYEE_ID ;

CREATE VIEW TBL_EMP_MANAGER AS 
SELECT 
	E.EMPLOYEE_ID ,
	E.FIRST_NAME || ' ' || E.LAST_NAME 사원이름 , 
	E.MANAGER_ID ,
...
SELECT * FROM TBL_EMP_MANAGER

--SELF JOIN
SELECT 
	E1.FIRST_NAME || ' ' || E.LAST_NAME 사원이름 ,
	E2.FIRST_NAME || ' ' || E2.LAST_NAME 메니저이름
FROM EMPLOYEES E1 
JOIN EMPLOYEES E2 
