...
SELECT E.EMPLOYEE_ID , E.MANAGER_ID M.JOB_ID ,J.JOB_TITLE
FROM EMPLOYEES e 
...
FROM EMPLOYEES e JOIN DEPARTMENTS d ON E.job_ID =D.job_ID =j.JOB_ID 
JOIN JOBS j ON E.
GROUP BY E.JOB_ID  
ORDER BY E.JOB_ID  ;

SELECT M.FIRST_NAME,M.LAST_NAME, COUNT(E.EMPLOYES_ID)
FROM EMPLOYEES M
